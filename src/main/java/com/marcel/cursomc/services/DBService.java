...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		produtoReporitory.save(Arrays.asList(p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17,
				p18, p19, p20, p21, p22, p23, p24, p25, p26, p27, p28, p29, p30, p31, p32, p34, p35, p36, p37, p38, p39,
		...
		Cliente cli1 = new Cliente(null, "Marcel Aguiar", "aguiar.marcel.bezerra@gmail.com", "29667474046",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("996156891", "33029828292"));

		Cliente cli2 = new Cliente(null, "Brenda Louise", "aguiar_marcel@hotmail.com", "13082313000",
				TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.getTelefones().addAll(Arrays.asList("994046424", "20481234567"));
		cli2.addPerfil(Perfil.ADMIN);

		Endereco end1 = new Endereco(null, "Rua Dionísio Filgueira", "764", "Ap 201", "Petrópolis", "59014-020", cli1,
				ci1);
		Endereco end2 = new Endereco(null, "Av. Professora Maria Sales", "212", "Ap 201", "Tambaú", "12321-500", cli1,
				ci3);
		Endereco end3 = new Endereco(null, "Av. brancas dunas", "2016", "Ap 203", "Candelária", "98988-400", cli2, ci2);
